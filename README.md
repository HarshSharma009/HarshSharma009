...
> 5+ years shipping high-throughput, resilient distributed systems
> in fintech and banking. Currently building regulated microservices
> at IDFC FIRST Bank. Previously at Kotak, Juspay, Apisero.
```
...
<table>
  <tr>
    ...
    <td align="center" width="25%">
      <b><code>99.99%</code></b><br/>
      <sub>delivery accuracy</sub>
    </td>
    <td align="center" width="25%">
      <b><code>1M+</code></b><br/>
      <sub>customers served</sub>
    </td>
    <td align="center" width="25%">
      <b><code>5+</code></b><br/>
...
╰─────────────────────────────┬────────────────────────────────╯
                              ▼
╭─[ 03 · ORCHESTRATION ]───────────────────────────────────────╮
│   ● Orchestrator      ● Risk Engine      ● Idempotency       │
╰─────────────────────────────┬────────────────────────────────╯
                              ▼
╭─[ 04 · EVENT BUS ]───────────────────────────────────────────╮
│   ● Apache Kafka  ·  5M+ events/day                          │
╰─────────────────────────────┬────────────────────────────────╯
                              ▼
╭─[ 05 · PAYMENT RAILS ]───────────────────────────────────────╮
│   ● NPCI / UPI     ● Visa · MasterCard     ● Stripe          │
╰─────────────────────────────┬────────────────────────────────╯
                              ▼
╭─[ 06 · STORAGE ]─────────────────────────────────────────────╮
...
<sub>The same diagram lives and breathes on my <a href="https://github.com/HarshSharma009/harshsharma-dev">portfolio hero</a> — with animated packets.</sub>
...
![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&labelColor=0A0A0F&logo=python&logoColor=FFFFFF)
![Rust](https://img.shields.io/badge/Rust-F97316?style=for-the-badge&labelColor=0A0A0F&logo=rust&logoColor=FFFFFF)
![Go](https://img.shields.io/badge/Go-00ADD8?style=for-the-badge&labelColor=0A0A0F&logo=go&logoColor=FFFFFF)
![Java](https://img.shields.io/badge/Java-ED8B00?style=for-the-badge&labelColor=0A0A0F&logo=openjdk&logoColor=FFFFFF)
...
| Company | Role | Period |
|---|---|---|
| **IDFC FIRST Bank** `● CURRENT` | Software Engineer | Dec 2025 – Present |
...
<div align="center">
  <sub>
    <code>&gt; let's build something fast and resilient ▌</code>
  </sub>
</div>
